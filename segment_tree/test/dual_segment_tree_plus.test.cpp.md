...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/dual_segment_tree_plus.test.cpp\"\n#define\
    \ PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_E\"\
    ...
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    DualSegmentTree<MonoidPlus<long\
    \ long>> seg(N);\n    while (Q--) {\n        int t;\n        std::cin >> t;\n\
    \        if (t == 0) {\n            int l, r, x;\n            std::cin >> l >>\
    \ r >> x;\n            seg.apply(--l, r, x);\n        } else {\n            int\
    \ i;\n            std::cin >> i;\n            std::cout << seg[--i] << '\\n';\n\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/dual_segment_tree_plus.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/dual_segment_tree_plus.test.cpp
- /verify/segment_tree/test/dual_segment_tree_plus.test.cpp.html
