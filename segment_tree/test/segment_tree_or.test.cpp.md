...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/segment_tree_or.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <iostream>\n\n#line 2\
    \ \"algebra/monoid/monoid_or.hpp\"\n\ntemplate <class T> struct MonoidOr {\n \
    ...
    \ << 1], d[(k << 1) | 1]);\n    }\n};\n#line 7 \"segment_tree/test/segment_tree_or.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/segment_tree_or.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/segment_tree_or.test.cpp
- /verify/segment_tree/test/segment_tree_or.test.cpp.html
