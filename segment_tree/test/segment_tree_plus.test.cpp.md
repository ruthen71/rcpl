...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/segment_tree_plus.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n\n#include\
    ...
    \ << 1], d[(k << 1) | 1]);\n    }\n};\n#line 7 \"segment_tree/test/segment_tree_plus.test.cpp\"\
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    std::vector<long\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/segment_tree_plus.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/segment_tree_plus.test.cpp
- /verify/segment_tree/test/segment_tree_plus.test.cpp.html
