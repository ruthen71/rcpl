...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/segment_tree_gcd.test.cpp\"\n#define PROBLEM\
    \ \"https://yukicoder.me/problems/no/1036\"\n\n#include <iostream>\n#include <numeric>\n\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/segment_tree_gcd.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/segment_tree_gcd.test.cpp
- /verify/segment_tree/test/segment_tree_gcd.test.cpp.html
