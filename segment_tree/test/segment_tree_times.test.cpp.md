...
data:
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n\n#include <iostream>\n\
    ...
    \ << a + b << '\\n';\n    return 0;\n}\n"
  dependsOn:
  - algebra/monoid/monoid_times.hpp
  ...
  requiredBy: []
  timestamp: '2026-04-11 01:16:54+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: segment_tree/test/segment_tree_times.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/segment_tree_times.test.cpp
- /verify/segment_tree/test/segment_tree_times.test.cpp.html
