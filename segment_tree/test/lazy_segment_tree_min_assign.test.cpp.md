...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/lazy_segment_tree_min_assign.test.cpp\"\
    \n#define PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_F\"\
    ...
    \ T none> struct ActedMonoidMinAssign {\n    using MS = MonoidMin<T, inf>;\n \
    ...
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    constexpr int INF\
    \ = std::numeric_limits<int>::max();\n    LazySegmentTree<ActedMonoidMinAssign<int,\
    \ INF, INF>> segmin(N);\n    LazySegmentTree<ActedMonoidMaxAssign<int, INF, INF>>\
    \ segmax(N);\n    while (Q--) {\n        int t;\n        std::cin >> t;\n    \
    \    if (t == 0) {\n            int l, r, x;\n            std::cin >> l >> r >>\
    \ x;\n            r++;\n            segmin.apply(l, r, x);\n            segmax.apply(l,\
    \ r, -x);\n        } else {\n            int l, r;\n            std::cin >> l\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/lazy_segment_tree_min_assign.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/lazy_segment_tree_min_assign.test.cpp
- /verify/segment_tree/test/lazy_segment_tree_min_assign.test.cpp.html
