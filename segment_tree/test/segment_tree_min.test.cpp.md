...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/segment_tree_min.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/staticrmq\"\n\n#include <iostream>\n#include\
    \ <limits>\n\n#line 2 \"algebra/monoid/monoid_max.hpp\"\n\ntemplate <class T,\
    \ T inf> struct MonoidMax {\n    using value_type = T;\n    static constexpr T\
    ...
    \ << 1], d[(k << 1) | 1]);\n    }\n};\n#line 9 \"segment_tree/test/segment_tree_min.test.cpp\"\
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    std::vector<int>\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/segment_tree_min.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/segment_tree_min.test.cpp
- /verify/segment_tree/test/segment_tree_min.test.cpp.html
