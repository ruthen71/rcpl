...
data:
  ...
  bundledCode: "#line 1 \"segment_tree/test/lazy_segment_tree_plus_assign.test.cpp\"\
    \n#define PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_I\"\
    ...
    \        lz[k] = MF::identity();\n    }\n};\n#line 9 \"segment_tree/test/lazy_segment_tree_plus_assign.test.cpp\"\
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    constexpr long long\
    \ NONE = std::numeric_limits<long long>::max();\n    LazySegmentTree<ActedMonoidPlusAssign<long\
    \ long, NONE>> seg(N);\n    while (Q--) {\n        int t;\n        std::cin >>\
    \ t;\n        if (t == 0) {\n            int l, r, x;\n            std::cin >>\
    \ l >> r >> x;\n            seg.apply(l, r + 1, x);\n        } else {\n      \
    \      int l, r;\n            std::cin >> l >> r;\n            std::cout << seg.prod(l,\
  ...
  code: "#define PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_I\"\
    ...
    \ N, Q;\n    std::cin >> N >> Q;\n    constexpr long long NONE = std::numeric_limits<long\
  ...
  verifiedWith: []
documentation_of: segment_tree/test/lazy_segment_tree_plus_assign.test.cpp
layout: document
redirect_from:
- /verify/segment_tree/test/lazy_segment_tree_plus_assign.test.cpp
- /verify/segment_tree/test/lazy_segment_tree_plus_assign.test.cpp.html
