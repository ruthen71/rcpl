...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"algebra/acted_monoid/acted_monoid_min_plus.hpp\"\n\n#line\
    ...
    \ T, T inf> struct ActedMonoidMinPlus {\n    using MS = MonoidMin<T, inf>;\n \
...
documentation_of: algebra/acted_monoid/acted_monoid_min_plus.hpp
layout: document
redirect_from:
- /library/algebra/acted_monoid/acted_monoid_min_plus.hpp
- /library/algebra/acted_monoid/acted_monoid_min_plus.hpp.html
