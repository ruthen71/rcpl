...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/heavy_light_decomposition_path_add_path_sum.test.cpp\"\
    \n#define PROBLEM \\\n    \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_5_E\"\
    \n\n#include <iostream>\n\n#line 2 \"algebra/acted_monoid/acted_monoid_plus_plus.hpp\"\
    ...
    \ i++) {\n        int p;\n        std::cin >> p;\n        p -= offset;\n     \
    \   T c = 1;\n        if (weight) std::cin >> c;\n        g.add_edge(p, i, c);\n\
    \    }\n    g.build();\n    return g;\n}\n#line 10 \"verify/graph/heavy_light_decomposition_path_add_path_sum.test.cpp\"\
    \n\nint main() {\n    int N;\n    std::cin >> N;\n    Graph<int> g(N, false);\n\
    \n    for (int i = 0; i < N; i++) {\n        int K;\n        std::cin >> K;\n\
    \        for (int j = 0; j < K; j++) {\n            int c;\n            std::cin\
    \ >> c;\n            g.add_edge(i, c, 1);\n        }\n    }\n    const int root\
    \ = N / 2;  // verify \u306E\u305F\u3081\u306B\u9069\u5F53\u306B\u6C7A\u3081\u308B\
    \n    HeavyLightDecomposition hld(g, root);\n    LazySegmentTree<ActedMonoidPlusPlus<long\
    \ long>> seg(N - 1);\n\n    int Q;\n    std::cin >> Q;\n    for (int i = 0; i\
    \ < Q; i++) {\n        int type;\n        std::cin >> type;\n        if (type\
    \ == 0) {\n            int v, w;\n            std::cin >> v >> w;\n          \
    ...
    \ : intervals) {\n                seg.apply(l, r, w);\n            }\n       \
    \ } else {\n            int v;\n            std::cin >> v;\n            auto intervals\
    \ = hld.path_query(0, v, true);\n            auto res = ActedMonoidPlusPlus<long\
  ...
  verifiedWith: []
documentation_of: verify/graph/heavy_light_decomposition_path_add_path_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/heavy_light_decomposition_path_add_path_sum.test.cpp
- /verify/verify/graph/heavy_light_decomposition_path_add_path_sum.test.cpp.html
