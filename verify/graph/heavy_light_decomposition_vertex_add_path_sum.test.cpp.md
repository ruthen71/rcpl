...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/heavy_light_decomposition_vertex_add_path_sum.test.cpp\"\
    ...
    \ i++) {\n        int p;\n        std::cin >> p;\n        p -= offset;\n     \
    \   T c = 1;\n        if (weight) std::cin >> c;\n        g.add_edge(p, i, c);\n\
    \    }\n    g.build();\n    return g;\n}\n#line 9 \"verify/graph/heavy_light_decomposition_vertex_add_path_sum.test.cpp\"\
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    std::vector<long\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_path_sum\"\n\
    ...
    \ < N; i++) std::cin >> a[i];\n    auto g = read_graph<long long>(N, N - 1, false,\
    \ false, 0);\n\n    const int root = N / 2;  // verify \u306E\u305F\u3081\u306B\
    \u9069\u5F53\u306B\u6C7A\u3081\u308B\n    HeavyLightDecomposition hld(g, root);\n\
    ...
    \        for (auto&& [l, r] : intervals) {\n                res = MonoidPlus<long\
    \ long>::operation(res, seg.prod(l, r));\n            }\n            std::cout\
    \ << res << '\\n';\n        }\n    }\n    return 0;\n}\n"
  dependsOn:
...
layout: document
redirect_from:
- /verify/verify/graph/heavy_light_decomposition_vertex_add_path_sum.test.cpp
- /verify/verify/graph/heavy_light_decomposition_vertex_add_path_sum.test.cpp.html
