...
data:
  ...
  bundledCode: "#line 1 \"verify/graph/heavy_light_decomposition_vertex_add_subtree_sum.test.cpp\"\
    ...
    \ i++) {\n        int p;\n        std::cin >> p;\n        p -= offset;\n     \
    \   T c = 1;\n        if (weight) std::cin >> c;\n        g.add_edge(p, i, c);\n\
    \    }\n    g.build();\n    return g;\n}\n#line 9 \"verify/graph/heavy_light_decomposition_vertex_add_subtree_sum.test.cpp\"\
    \n\nint main() {\n    int N, Q;\n    std::cin >> N >> Q;\n    std::vector<long\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_subtree_sum\"\
    ...
    \ < N; i++) std::cin >> a[i];\n    auto g = read_parent<long long>(N, false, false,\
    \ 0);\n\n    const int root = 0;\n    HeavyLightDecomposition hld(g, root);\n\
  ...
  verifiedWith: []
documentation_of: verify/graph/heavy_light_decomposition_vertex_add_subtree_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/graph/heavy_light_decomposition_vertex_add_subtree_sum.test.cpp
- /verify/verify/graph/heavy_light_decomposition_vertex_add_subtree_sum.test.cpp.html
