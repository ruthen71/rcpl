...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj_cgl/aoj_cgl_2_b.test.cpp\"\n#define PROBLEM \"\
    http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B\"\n\n#include\
    ...
    \ s2.b, s1.b) <= 0); }\n#line 6 \"verify/aoj_cgl/aoj_cgl_2_b.test.cpp\"\n\nint\
    \ main() {\n    int Q;\n    std::cin >> Q;\n    while (Q--) {\n        Segment\
    \ S1, S2;\n        std::cin >> S1 >> S2;\n        std::cout << is_intersect_ss(S1,\
    \ S2) << '\\n';\n    }\n    return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/verify/aoj_cgl/aoj_cgl_2_b.test.cpp
- /verify/verify/aoj_cgl/aoj_cgl_2_b.test.cpp.html
