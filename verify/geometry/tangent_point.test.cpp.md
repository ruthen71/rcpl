...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/tangent_point.test.cpp\"\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F\"\n#define\
    \ ERROR 0.00001\n\n#include <iostream>\n#include <iomanip>\n#include <algorithm>\n\
    \n#line 2 \"geometry/tangent_point.hpp\"\n\n#line 2 \"geometry/point.hpp\"\n\n\
    ...
    \ p) - c.r * c.r)));\n}\n#line 9 \"verify/geometry/tangent_point.test.cpp\"\n\n\
    int main() {\n    Point<double> P;\n    Circle<double> C;\n    std::cin >> P >>\
  ...
  verifiedWith: []
documentation_of: verify/geometry/tangent_point.test.cpp
layout: document
redirect_from:
- /verify/verify/geometry/tangent_point.test.cpp
- /verify/verify/geometry/tangent_point.test.cpp.html
