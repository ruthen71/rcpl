...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/cross_point_cc.test.cpp\"\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E\"\n#define\
    \ ERROR 0.000001\n\n#include <iostream>\n#include <iomanip>\n#include <algorithm>\n\
    ...
    \    return {p, q};\n}\n#line 9 \"verify/geometry/cross_point_cc.test.cpp\"\n\n\
    int main() {\n    Circle<double> C1, C2;\n    std::cin >> C1 >> C2;\n    auto\
    \ res = cross_point(C1, C2);\n    std::sort(res.begin(), res.end());\n    if (res.size()\
  ...
  verifiedWith: []
documentation_of: verify/geometry/cross_point_cc.test.cpp
layout: document
redirect_from:
- /verify/verify/geometry/cross_point_cc.test.cpp
- /verify/verify/geometry/cross_point_cc.test.cpp.html
