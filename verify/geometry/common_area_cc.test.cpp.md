...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/common_area_cc.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_I\"\n#define\
    \ ERROR 0.000001\n\n#include <iostream>\n#include <iomanip>\n\n#line 2 \"geometry/common_area.hpp\"\
    \n\n#line 2 \"geometry/circle.hpp\"\n\n#line 2 \"geometry/point.hpp\"\n\n#include\
    \ <cassert>\n#include <cmath>\n\n#line 2 \"geometry/geometry_template.hpp\"\n\n\
    #include <type_traits>\n\n// Constants (EPS, PI)\n// EPS \u306E\u5909\u66F4\u306F\
    \ Constants<T>::set_eps(new_eps) \u3067\ntemplate <class T> struct Constants {\n\
    ...
    \ <class T> int tangent_number(Circle<T> c1, Circle<T> c2) {\n    if (c1.r < c2.r)\
    \ std::swap(c1, c2);\n    const T d2 = norm(c1.o - c2.o);\n    if (sign(d2 - (c1.r\
    \ + c2.r) * (c1.r + c2.r)) == 1)\n        return 4;  // d > c1.r + c2.r and c1.r\
    \ + c2.r >= 0 <=> d ^ 2 > (c1.r +\n                   // c2.r) ^ 2\n    if (sign(d2\
    \ - (c1.r + c2.r) * (c1.r + c2.r)) == 0)\n        return 3;  // d = c1.r + c2.r\
    ...
    \    return 1;  // d = c1.r - c2.r and c1.r - c2.r >= 0 <=> d ^ 2 = (c1.r -\n\
    ...
    geometry/cross_point.hpp\"\n\n#line 5 \"geometry/cross_point.hpp\"\n\n#line 2\
    ...
    \ != 0 -> \u5E73\u884C\u3067\u306A\u3044\u306E\u3067\u4EA4\u5DEE\u3059\u308B\n\
    \    // sign(d12) == 0 and sign(d1) == 0 -> \u4E00\u81F4\u3059\u308B\u306E\u3067\
    \u4EA4\u5DEE\u3059\u308B\n    return sign(d12) != 0 or sign(d1) == 0;\n}\n// \u76F4\
    \u7DDA l, \u70B9 p \u306E\u4EA4\u5DEE\u5224\u5B9A\ntemplate <class T>\ninline\
    \ bool is_intersect(const Line<T>& l, const Point<T>& p) {\n    auto res = ccw(l.a,\
    \ l.b, p);\n    return res == Ccw::ONLINE_BACK or res == Ccw::ONLINE_FRONT or\n\
    \           res == Ccw::ON_SEGMENT;\n}\ntemplate <class T> bool is_intersect(const\
    \ Point<T>& p, const Line<T>& l) {\n    return is_intersect(l, p);\n}\n\n// \u7DDA\
    \u5206 s, \u70B9 p \u306E\u4EA4\u5DEE\u5224\u5B9A\ntemplate <class T>\ninline\
    \ bool is_intersect(const Segment<T>& s, const Point<T>& p) {\n    return ccw(s.a,\
    \ s.b, p) == Ccw::ON_SEGMENT;\n}\ntemplate <class T>\ninline bool is_intersect(const\
    ...
    \ <class T> bool is_intersect(const Segment<T>& s, const Line<T>& l) {\n    return\
    \ is_intersect(l, s);\n}\n\n// \u7DDA\u5206 s1, s2 \u306E\u4EA4\u5DEE\u5224\u5B9A\
    ...
    template <class T>\nPoint<T> cross_point(const Segment<T>& s1, const Segment<T>&\
    \ s2) {\n    static_assert(is_geometry_floating_point<T>::value == true);\n  \
    ...
    template <class T>\nstd::vector<Point<T>> cross_point(const Circle<T>& c, const\
    \ Line<T>& l) {\n    static_assert(is_geometry_floating_point<T>::value == true);\n\
    \    auto pr = projection(l, c.o);\n    if (equal(norm(pr - c.o), c.r * c.r))\
    \ return {pr};\n    Point<T> e = (l.b - l.a) / abs(l.b - l.a);\n    auto k = sqrtl(c.r\
    \ * c.r - norm(pr - c.o));\n    return {pr - e * k, pr + e * k};\n}\ntemplate\
    \ <class T>\nstd::vector<Point<T>> cross_point(const Line<T>& l, const Circle<T>&\
    \ c) {\n    return cross_point(c, l);\n}\n\n// \u5186 c, \u7DDA\u5206 s \u306E\
    \u4EA4\u70B9 1 or 2 \u3064\ntemplate <class T>\nstd::vector<Point<T>> cross_point(const\
    ...
    \    return res;\n}\ntemplate <class T>\nstd::vector<Point<T>> cross_point(const\
    \ Segment<T>& s, const Circle<T>& c) {\n    return cross_point(c, s);\n}\n\n//\
    \ \u5186 c1, c2 \u306E\u4EA4\u70B9 1 or 2 \u3064\n// http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E\n\
    template <class T>\nstd::vector<Point<T>> cross_point(const Circle<T>& c1, const\
    \ Circle<T>& c2) {\n    static_assert(is_geometry_floating_point<T>::value ==\
    ...
    \ - c2.o) / 2;\n    return res;\n}\n#line 8 \"verify/geometry/common_area_cc.test.cpp\"\
    \n\nint main() {\n    Circle<double> c1, c2;\n    std::cin >> c1 >> c2;\n    std::cout\
    \ << std::fixed << std::setprecision(15) << common_area(c1, c2) << '\\n';\n  \
    \  return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/geometry/common_area_cc.test.cpp
layout: document
redirect_from:
- /verify/verify/geometry/common_area_cc.test.cpp
- /verify/verify/geometry/common_area_cc.test.cpp.html
