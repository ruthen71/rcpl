...
data:
  ...
  bundledCode: "#line 1 \"verify/geometry/is_intersect_ss.test.cpp\"\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B\"\n\n#include\
    ...
    \ {\n    return is_intersect(c, s);\n}\n#line 6 \"verify/geometry/is_intersect_ss.test.cpp\"\
    \n\nint main() {\n    int Q;\n    std::cin >> Q;\n    while (Q--) {\n        Segment<long\
  ...
  verifiedWith: []
documentation_of: verify/geometry/is_intersect_ss.test.cpp
layout: document
redirect_from:
- /verify/verify/geometry/is_intersect_ss.test.cpp
- /verify/verify/geometry/is_intersect_ss.test.cpp.html
